...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 1372 (incl. 774 user, 538 helpers, 12 vtables, 48 lits); src size 0
; assembly: 947 lines; density: 154.8 bytes/stmt; (5 stmts)
; total bytes: 216412 (89.2% of 237.0k flash with 26276 free)
; peep hole pass: 21 instructions removed and 19 updated
...
; start
    ...
    .hex 379A7128EAF45167 ; hex template hash
    .hex 8E1DACB9D3A111B1 ; program hash
    .short 5   ; num. globals
